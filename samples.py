...
#         },
#         "ST_tW_antitop_5f_ID": {
#             "folder": main_dir + "ST_tW_antitop_5f_InclusiveDecays" + suffix3 + "1/",
#             "xsec": 35.85,
#         },
#         "ST_tW_top_5f_NFHD": {
#             "folder": main_dir + "ST_tW_top_5f_NoFullyHadronicDecays" + suffix3 + "1/",
#             "xsec": 19.56,
#         },
#         "ST_tW_top_5f_ID": {
#             "folder": main_dir + "ST_tW_top_5f_InclusiveDecays" + suffix3 + "1/",
#             "xsec": 35.85,
#         },
...
#             "folder": main_dir + "ST_t-channel_top_4f_InclusiveDecays" + suffix3 + "1/",
#             "xsec": 136.02,
#         },
...
#         },
#         "ST_s-channel_4f_LD": {
#             "folder": main_dir + "ST_s-channel_4f_LeptonDecays" + suffix3 + "1/",
#             "xsec": 3.36,
#         },
#         "TTTo2L2Nu": {
#             "folder": main_dir + "TTTo2L2Nu" + suffix3 + "1/",
#             "xsec": 85.65,
#         },  # 88.29
#         "TTToSemiLeptonic": {
#             "folder": main_dir + "TTToSemiLeptonic" + suffix3 + "1/",
#             "xsec": 356.19,
#         },  # 365.34
#         "TTToHadronic": {
#             "folder": main_dir + "TTToHadronic" + suffix3 + "1/",
#             "xsec": 366.20,
#         },  # 377.96
#     }
# )
...
samples.update(
    {
        ...
        # "WZTo3LNu": {
        #     "folder": main_dir + "WZTo3LNu" + suffix3 + "1/",
        #     "xsec": 47.13 * 21.34 * 10.099 / 10000.0,
        #     "subsamples": flavourSplitting,
        # },
        # "WWTo2L2Nu": {
        #     "folder": main_dir + "WWTo2L2Nu" + suffix3 + "1/",
...
#     {
#         "ZH": {
#             "folder": main_dir + "ZH_HToBB_ZToLL_M125" + suffix3 + "1/",
#             "xsec": 0.880 * 58.09 * (3.3632 + 3.3662 + 3.3696) / 10000.0,
#         },  # 0.04718 (AN)
#         "ggZH": {
#             "folder": main_dir + "ggZH_HToBB_ZToLL_M125" + suffix3 + "1/",
