...
ROOT::VecOps::RVec<int> func__SelectedMuon(unsigned int __slot , const ROOT::VecOps::RVec<Bool_t> & Muon_mediumId, const ROOT::VecOps::RVec<Float_t> & Muon_eta, const ROOT::VecOps::RVec<Float_t> & Muon_pt, const ROOT::VecOps::RVec<float> & Muon_iso) {  return Muon_iso < 0.25 && Muon_mediumId && Muon_pt > 20. && abs(Muon_eta) < 2.4; }
...
ROOT::VecOps::RVec<float> func__SelectedMuon_mass(unsigned int __slot , const ROOT::VecOps::RVec<Float_t> & Muon_mass, const ROOT::VecOps::RVec<int> & SelectedMuon) {  return At(Muon_mass,SelectedMuon); }
...
ROOT::VecOps::RVec<float> func__SelectedMuon_pt(unsigned int __slot , const ROOT::VecOps::RVec<Float_t> & Muon_pt, const ROOT::VecOps::RVec<int> & SelectedMuon) {  return At(Muon_pt,SelectedMuon); }
...
int func__Mu1(unsigned int __slot , const unsigned long & Mu_index, const ROOT::VecOps::RVec<unsigned long> & MuMu1) {  return int(At(MuMu1,Mu_index)); }
ROOT::Math::LorentzVector<ROOT::Math::PtEtaPhiM4D<float> > func__Mu1_p4(unsigned int __slot , const ROOT::VecOps::RVec<ROOT::Math::LorentzVector<ROOT::Math::PtEtaPhiM4D<float> > > & SelectedMuon_p4, const int & Mu1) {  return At(SelectedMuon_p4,Mu1); }
...
ROOT::VecOps::RVec<int> func__GenMuon(unsigned int __slot , const ROOT::VecOps::RVec<Float_t> & GenPart_eta, const ROOT::VecOps::RVec<Int_t> & GenPart_status, const ROOT::VecOps::RVec<Int_t> & GenPart_pdgId, const ROOT::VecOps::RVec<Float_t> & GenPart_pt) {  return abs(GenPart_pdgId) == 13 && GenPart_status == 1 && GenPart_pt > 20. && abs(GenPart_eta) < 2.4; }
ROOT::VecOps::RVec<float> func__GenMuon_eta(unsigned int __slot , const ROOT::VecOps::RVec<int> & GenMuon, const ROOT::VecOps::RVec<Float_t> & GenPart_eta) {  return At(GenPart_eta,GenMuon); }
...
ROOT::VecOps::RVec<float> func__GenMuon_phi(unsigned int __slot , const ROOT::VecOps::RVec<Float_t> & GenPart_phi, const ROOT::VecOps::RVec<int> & GenMuon) {  return At(GenPart_phi,GenMuon); }
ROOT::VecOps::RVec<float> func__GenMuon_pt(unsigned int __slot , const ROOT::VecOps::RVec<int> & GenMuon, const ROOT::VecOps::RVec<Float_t> & GenPart_pt) {  return At(GenPart_pt,GenMuon); }
...
ROOT::VecOps::RVec<unsigned long> func__GenMuMu0(unsigned int __slot , const ROOT::VecOps::RVec<ROOT::VecOps::RVec<unsigned long> > & GenMuMu_allpairs, const ROOT::VecOps::RVec<int> & GenMuMu) {  return At(At(GenMuMu_allpairs,0),GenMuMu); }
ROOT::VecOps::RVec<unsigned long> func__GenMuMu1(unsigned int __slot , const ROOT::VecOps::RVec<ROOT::VecOps::RVec<unsigned long> > & GenMuMu_allpairs, const ROOT::VecOps::RVec<int> & GenMuMu) {  return At(At(GenMuMu_allpairs,1),GenMuMu); }
...
ROOT::VecOps::RVec<double> func__GenMuMu1_charge(unsigned int __slot , const ROOT::VecOps::RVec<unsigned long> & GenMuMu1, const ROOT::VecOps::RVec<double> & GenMuon_charge) {  return Take(GenMuon_charge,GenMuMu1); }
ROOT::VecOps::RVec<unsigned long> func__OppositeSignGenMuMu(unsigned int __slot , const ROOT::VecOps::RVec<double> & GenMuMu1_charge, const ROOT::VecOps::RVec<double> & GenMuMu0_charge) {  return Nonzero(GenMuMu0_charge != GenMuMu1_charge); }
...
int func__GenMu1(unsigned int __slot , const ROOT::VecOps::RVec<unsigned long> & GenMuMu1, const unsigned long & GenMu_index) {  return int(At(GenMuMu1,GenMu_index)); }
ROOT::Math::LorentzVector<ROOT::Math::PtEtaPhiM4D<float> > func__GenMu1_p4(unsigned int __slot , const ROOT::VecOps::RVec<ROOT::Math::LorentzVector<ROOT::Math::PtEtaPhiM4D<float> > > & GenMuon_p4, const int & GenMu1) {  return At(GenMuon_p4,GenMu1); }
...
.DefineSlot("SelectedMuon",func__SelectedMuon,{"Muon_mediumId","Muon_eta","Muon_pt","Muon_iso"})
.DefineSlot("SelectedMuon_eta",func__SelectedMuon_eta,{"SelectedMuon","Muon_eta"})
.DefineSlot("SelectedMuon_mass",func__SelectedMuon_mass,{"Muon_mass","SelectedMuon"})
.DefineSlot("SelectedMuon_phi",func__SelectedMuon_phi,{"SelectedMuon","Muon_phi"})
.DefineSlot("SelectedMuon_pt",func__SelectedMuon_pt,{"Muon_pt","SelectedMuon"})
...
.DefineSlot("SelectedMuon_p4",func__SelectedMuon_p4,{"SelectedMuon_phi","SelectedMuon_mass","SelectedMuon_pt","SelectedMuon_eta"})
.DefineSlot("MuMu_allpairs",func__MuMu_allpairs,{"SelectedMuon"})
.DefineSlot("MuMu",func__MuMu,{"MuMu_allpairs"})
.DefineSlot("MuMu0",func__MuMu0,{"MuMu","MuMu_allpairs"})
.DefineSlot("MuMu1",func__MuMu1,{"MuMu","MuMu_allpairs"})
...
.DefineSlot("Mu1",func__Mu1,{"Mu_index","MuMu1"})
.DefineSlot("Mu1_p4",func__Mu1_p4,{"SelectedMuon_p4","Mu1"})
.DefineSlot("Z",func__Z,{"Mu0_p4","Mu1_p4"})
.DefineSlot("Reco_Zpt",func__Reco_Zpt,{"Z"})
.DefineSlot("Reco_ZMass",func__Reco_ZMass,{"Z"})
.DefineSlot("GenMuon",func__GenMuon,{"GenPart_eta","GenPart_status","GenPart_pdgId","GenPart_pt"})
.DefineSlot("GenMuon_eta",func__GenMuon_eta,{"GenMuon","GenPart_eta"})
.DefineSlot("GenMuon_mass",func__GenMuon_mass,{"GenMuon","GenPart_mass"})
.DefineSlot("GenMuon_phi",func__GenMuon_phi,{"GenPart_phi","GenMuon"})
.DefineSlot("GenMuon_pt",func__GenMuon_pt,{"GenMuon","GenPart_pt"})
...
.DefineSlot("GenMuon_p4",func__GenMuon_p4,{"GenMuon_mass","GenMuon_phi","GenMuon_eta","GenMuon_pt"})
...
.DefineSlot("GenMuMu0",func__GenMuMu0,{"GenMuMu_allpairs","GenMuMu"})
.DefineSlot("GenMuMu1",func__GenMuMu1,{"GenMuMu_allpairs","GenMuMu"})
.DefineSlot("GenMuMu0_charge",func__GenMuMu0_charge,{"GenMuon_charge","GenMuMu0"})
.DefineSlot("GenMuMu1_charge",func__GenMuMu1_charge,{"GenMuMu1","GenMuon_charge"})
.DefineSlot("OppositeSignGenMuMu",func__OppositeSignGenMuMu,{"GenMuMu1_charge","GenMuMu0_charge"})
...
.DefineSlot("GenMu1",func__GenMu1,{"GenMuMu1","GenMu_index"})
.DefineSlot("GenMu1_p4",func__GenMu1_p4,{"GenMuon_p4","GenMu1"})
